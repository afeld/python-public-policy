...
_While the Reader is the intended audience here, others are welcome to read it._
...
- Instructor can [export enrollment activity](https://python-public-policy.afeld.me/en/columbia/meta/instructor_guide.html#student-enrollment-activity) for you
...
- If the proposal shows effort and follows the [format](https://python-public-policy.afeld.me/en/columbia/final_project/proposal.html#format), full credit should be given
...
[The Final Projects themselves are peer graded.](https://python-public-policy.afeld.me/en/columbia/final_project/peer_grading.html)  Once the peer review deadline passes:
