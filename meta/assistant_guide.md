...
- [ ] Dates are correct:
  ...
  - [ ] [{{assignment_cutoff_name}} should be one week following the Due Date](https://python-public-policy.afeld.me/en/{{school_slug}}/syllabus.html#late-submission-deadline), at the same time
