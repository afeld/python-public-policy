...
See the [school policies]({{auditing}}). If there's a [wait list](joining_late.md#wait-list), priority for spots in the class will be given to students taking it for credit. See information about [what you can do while waiting](joining_late.md#while-youre-waiting).
