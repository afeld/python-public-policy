...
| ---------------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| [0](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_0.ipynb) | 10/24 | Introduction to Python, Google Colab Notebook & GitHub. Opening data and exploring the contents  | HW0 due (survey & GitHub account creation), HW1 assigned |
| [1](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_1.ipynb) | 10/31 | Python data structures and Pandas. Data cleanup, iterating with "for" loops, basic summary stats | HW1 due, HW2 assigned                                    |
| [2](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_2.ipynb) | 11/07 | Manipulating and combining Pandas DataFrames, writing functions                                  | HW2 due, HW3 assigned                                    |
| [3](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_3.ipynb) | 11/14 | Data visualization                                                                               | HW3 due, HW4 assigned                                    |
| [4](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_4.ipynb) | 11/21 | Linear regression and inferential statistics                                                     | HW4 due, HW5 assigned                                    |
| [5](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_5.ipynb) | 12/05 | Working with dates and time series analysis                                                      | HW5 due, HW6 assigned                                    |
| [6](https://github.com/afeld/nyu-python-public-policy/blob/master/lecture_6.ipynb) | 12/12 | Review course content and topics of student choice                                               | HW6 due, HW7 assigned - Due 12/19                        |
