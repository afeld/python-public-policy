...
- [How the wait list works](https://registrar.columbia.edu/content/class-registration-students)
...
- Look through the [important links](index.md#important-links), including [past lectures](syllabus.md#schedule).
   ...
   - You won't be able to access [Gradescope](https://courseworks2.columbia.edu/courses/233960) or the [Ed Discussion](https://courseworks2.columbia.edu/courses/233960/external_tools/37606?display=borderless).
...
- Make sure to read through the pinned threads that appear at the top of the list of [Ed Discussion](https://courseworks2.columbia.edu/courses/233960/external_tools/37606?display=borderless), in case there's anything you missed.
